# Usage:
# python ResNet_model.py --job F5_rep1 --Landmark F_5 
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Launch ResNet model ! Landmark specific models")
    ...
    model = keras.Sequential([
        ...
        Flatten(),
	layers.Dense(512, activation='relu', kernel_regularizer=l1_l2(l1=0.5, l2=0.5)),
    	Dropout(0.4),
    	layers.BatchNormalization(),
    	layers.Dense(128, activation='relu', kernel_regularizer=l1_l2(l1=0.5, l2=0.5)),
    	Dropout(0.5),
    	layers.BatchNormalization(),
    	layers.Dense(2, kernel_regularizer=l1_l2(l1=0.5, l2=0.5))
        ])
